package com.devtalk.algorithm.array;
...
public class MedianOfTwoSortedArraysOfSameSize {
	...
	static int getMedian(int ar1[], int ar2[], int n) {
		...
		/*
		 * Since there are 2n elements, median will be average of elements at index n-1
		 * and n in the array obtained after merging ar1 and ar2
		 */
