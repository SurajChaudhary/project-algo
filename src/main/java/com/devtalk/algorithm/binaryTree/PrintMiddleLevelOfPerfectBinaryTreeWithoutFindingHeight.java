...
public class PrintMiddleLevelOfPerfectBinaryTreeWithoutFindingHeight {
	...
	private static void printMiddleLevel(Node node) {
	...
	private static void printMiddleLevelUtil(Node a, Node b) {
		...
		printMiddleLevelUtil(a.right, b.right.left);
	}
